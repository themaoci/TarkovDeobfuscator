	...
	public class Program {
		...
		public static int Main(string[] args) {
			...
			try {
				...
				//Logger.n("");
				Logger.n("Starting de4dot deobfuscation... (using version: {0})", System.Reflection.Assembly.GetExecutingAssembly().GetName().Version);
				//Logger.n("");
			...
			//	}
			//}
			Logger.n("Deobfuscation finished [{0}]", exitCode);
